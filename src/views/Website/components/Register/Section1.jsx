  ...
  return (
    <div className="mt-10 flex flex-col lg:px-26 md:px-10 px-5">
      ...
      <div className="flex md:w-1/2 w-full flex-col gap-5 my-20">
        ...
        <div>
            <MainInput label="Username" isreq={true} type="text" />
        </div>
        <div>
        ...
        <div className="w-full cursor-pointer">
            <RedButtonLink link="/account-setting" text="Register" width="w-full"/>
        </div>
        <div className=" text-gray-500 text-sm">Does Have Account ? <Link className="underline text-blue-500" to={'/login'}>Login</Link></div>
      </div>
    </div>
  );
};
